#!/bin/bash
#SBATCH --job-name=stricthenipabeast
...
/global/home/users/cbrook/beast/bin/beast -beagle_cpu -seed 777 /global/scratch/users/cbrook/BEAST-henipa-strict/Henipa.xml
