...
tree <- read.beast(file = paste0(homewd, "/Fig3/henipa-AVG.tree"))
...
dat <- read.csv(file = paste0(homewd, "/Fig3/beast_seq.csv"), header = T, stringsAsFactors = F)
head(dat)
...
ggsave(file = paste0(homewd, "/final-figures/Fig3supp.png"),
       plot=p2,
       units="mm",  
       width=70, 
       height=90, 
