#!/bin/bash
#SBATCH --job-name=resumestricthenipabeast
...
/global/home/users/cbrook/beast/bin/beast -beagle_cpu -seed 777 -resume /global/scratch/users/cbrook/henipa-strict-resume/Henipa.xml
